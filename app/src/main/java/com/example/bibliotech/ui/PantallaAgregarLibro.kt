...
fun PantallaAgregarLibro(
    ...
    Scaffold(containerColor=Color.Black,
        ...
        Column(modifier = Modifier.fillMaxSize().padding(20.dp).background(Color.Black).verticalScroll(rememberScrollState()).padding(paddingValues)) {
            ...
            Button(
                onClick = {
                    ...
                    viewModel.insertarLibros(nuevoLibro)
                    onGuardar()
                },
                modifier = Modifier.fillMaxWidth()
            ) {
